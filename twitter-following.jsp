        ...
        <div class="row">
            ...
            <div class="span8 content-main">
                <div class="module">
                    ...
                    <%
                    	String following_person = "";
       
       		java.sql.Statement stmt_tweet = con.createStatement();

 String get_following = "SELECT login_t.fullname, login_t.login_id, login_t.username FROM login_t, following_t, tweet_t WHERE following_t.following_id = login_t.login_id AND following_t.follower_id = " + login_id + " GROUP BY login_t.login_id";
java.sql.ResultSet names_result = stmt_tweet.executeQuery(get_following);
                    	...
                    	if(!(names_result.getString(2).equalsIgnoreCase(login_id)))
                    	{
                    		...
                    		following_person = names_result.getString(1); //tweeting user
                    		String tweeter_username = names_result.getString(3);
                    		String check_id = names_result.getString(2);
                            ...
                            <div class="tweet original-tweet">
                            	...
                            	<a href="twitter-unfollow.jsp?login_id=<%=login_id%>&check_id=<%=names_result.getString(2)%>" class="btn btn-small" role="button"><font color="black">Unfollow</font> </a>
                                        ...
                                        <a class="account-group">
                                    	 ...
                                    	 <b class="fullname"><strong><%=following_person%></strong></b>                               				
