...
<body class="user-style-theme1">
    ...
    <div class="container wrap">
       ...
       String get_tweet = "SELECT login_t.fullname, tweet_t.tweet, tweet_t.tweet_date, tweet_t.login_id, hash_tweet_t.tweet_id, tweet_t.tweet_id FROM tweet_t, login_t, hash_tweet_t WHERE tweet_t.login_id = login_t.login_id AND tweet_t.login_id =" + login_id + " GROUP BY tweet_t.tweet_id";
...
java.sql.ResultSet tweets_result = stmt_tweet.executeQuery(get_tweet);
					...
					%>
                        ...
                        <div class="js-stream-item stream-item expanding-string-item">
                        	...
                        	<a href="twitter-delete.jsp?login_id=<%=login_id%>&tweeter=<%=tweets_result.getString(6)%>" class="btn btn-small" role="button"><font color="black">Delete</font> </a>
