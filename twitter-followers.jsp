        ...
        <div class="row">
            ...
            <div class="span8 content-main">
                <div class="module">
                    ...
                    <%
                           		java.sql.Statement stmt_t = con.createStatement();
...
java.sql.ResultSet following_results = stmt_t.executeQuery(get_following);
String ids = "";
 ...
 String get_follower = "SELECT login_t.fullname, login_t.login_id, login_t.username FROM login_t, following_t, tweet_t WHERE following_t.follower_id = login_t.login_id AND following_t.following_id = " + login_id + " GROUP BY login_t.login_id";
java.sql.ResultSet names_result = stmt_tweet.executeQuery(get_follower);
                    	...
                    	if(!(names_result.getString(2).equalsIgnoreCase(login_id)))
                    	{
                    		...
                    		String follower_id = names_result.getString(2);
                    		String tweeter_username = names_result.getString(3);
					...
					<div class="js-stream-item stream-item expanding-string-item">
    						...
    						<%	if(!(ids.contains(" " + follower_id + " " ))){	%>
                        	<a href="twitter-stalk.jsp?login_id=<%=login_id%>&check_id=<%=names_result.getString(2)%>" class="btn btn-small" role="button"><font color="black">Follow</font> </a>
 								<%}%>
 								
 								<%	if((ids.contains(" " + follower_id + " " ))){	%>
                        	<a href="twitter-unfollow.jsp?login_id=<%=login_id%>&check_id=<%=names_result.getString(2)%>" class="btn btn-small" role="button"><font color="black">Unfollow</font> </a>
 								<%}%>
