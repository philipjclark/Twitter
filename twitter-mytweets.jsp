                ...
                <div class="module mini-profile">
                    <div class="content">
                        <div class="account-group">
                            ...
                            <% String redirect_home = "<a href=twitter-home.jsp?login_id=" + login_id + ">" + fullname + "</a>";  %>      
                    ...
                    <div class="js-mini-profile-stats-container">
                        <ul class="stats">
                            <li><a href="#"><strong><%=finalnumtweets%></strong>Tweets</a></li>
...
String get_tweet = "SELECT login_t.fullname, tweet_t.tweet, tweet_t.tweet_date, tweet_t.login_id, tweet_t.tweet_id FROM tweet_t WHERE tweet_t.login_id =" + login_id;
                                ...
                                <div class="content">
                                    ...
                                    for(int j = 0; j < words.length; j++)
                                    {
                                    	...
                                    	if(words[j].substring(0,1).equals("#")) {
                                    	    ...
                                    	    %> 
                                    	    <a href ="twitter-hashtag.jsp?hashtag=<%=hash_tag%>&login_id=<%=login_id%>"> <%=words[j]%> </a><%=" "%> 
                                    	    <%
                                    	}
                                    	else {
                                    	    out.println(words[j] + " "); 
